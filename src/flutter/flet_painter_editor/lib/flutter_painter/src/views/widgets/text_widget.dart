...
class EditTextWidgetState extends State<EditTextWidget>
  ...
  void onEditingComplete() {
    if (textEditingController.text.trim().isEmpty) {
      ...
      // Preserve the original style and merge with settings
      final originalStyle = widget.drawable.style;
      final settingsStyle = settings.textStyle;
      
      final mergedStyle = originalStyle.copyWith(
        fontFamily: originalStyle.fontFamily ?? settingsStyle.fontFamily,
        fontSize: originalStyle.fontSize ?? settingsStyle.fontSize,
        fontWeight: originalStyle.fontWeight ?? settingsStyle.fontWeight,
        fontStyle: originalStyle.fontStyle ?? settingsStyle.fontStyle,
        color: originalStyle.color ?? settingsStyle.color,
        decoration: originalStyle.decoration ?? settingsStyle.decoration,
        decorationColor: originalStyle.decorationColor ?? settingsStyle.decorationColor,
        decorationStyle: originalStyle.decorationStyle ?? settingsStyle.decorationStyle,
        decorationThickness: originalStyle.decorationThickness ?? settingsStyle.decorationThickness,
        letterSpacing: originalStyle.letterSpacing ?? settingsStyle.letterSpacing,
        wordSpacing: originalStyle.wordSpacing ?? settingsStyle.wordSpacing,
        height: originalStyle.height ?? settingsStyle.height,
      );
